...
description = "GSPNR - includes charging to center; panel4 has NO wait state; inspection reward at 200";

save("second_iteration_model2.mat", "description", "solarfarm", "mdp", "markings", "states", "types");